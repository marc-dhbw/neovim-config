...
require("lazy").setup({
	...
	{ "Bilal2453/luvit-meta", lazy = true },
	{
		...
		config = function()
			...
			local servers = {
				-- clangd = {},
				-- clangd is the Language Server Protocol implementation for C and C++
				clangd = {
					-- Command to start the clangd server with specific options
					cmd = { "clangd", "--background-index" },
					-- File types for which clangd should be active
					...
					settings = {
						clangd = {
							...
							-- Fallback compilation flags when no compilation database is found
							fallbackFlags = { "-std=c++20" },
						},
					},
					-- Custom capabilities for the LSP client
					capabilities = {
	...
	-- Neo-tree installation and configuration with lazy.nvim
	{
		"nvim-neo-tree/neo-tree.nvim",
		branch = "v2.x", -- Use the stable v2.x branch
		dependencies = {
			"nvim-lua/plenary.nvim", -- Required dependency for various Lua functions
